...
public enum AppError {
  ...
  PERMISSION_NOT_EXIST(1030, "Permission not found", HttpStatus.NOT_FOUND),
  ...
  // Role related errors
  ROLE_NOT_EXIST(1040, "Role not found", HttpStatus.NOT_FOUND),
  ...
  SECTION_NOT_EXIST(2001, "Section not found", HttpStatus.NOT_FOUND),
  ...
  ARTICLE_NOT_EXIST(2001, "Article not found", HttpStatus.NOT_FOUND),
